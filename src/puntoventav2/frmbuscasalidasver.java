 ...
 */
public class frmbuscasalidasver extends javax.swing.JFrame {

    /**
     * Creates new form frmbuscasalidasver
     */
        ...
        try 
            ...
            frmversalidas.txtnosalida.setText(idsalida);
                ...
                {    String fecha, fechapago,anio,aniopago,mes,mespago,dias,diaspago;   
                     ...
                     fecha=dias+"/"+mes+"/"+anio;
                     frmversalidas.txtfecha.setText(fecha);
                ...
                {   filas2[0] =   rs3.getString(4);
                    ...
                    frmversalidas.modeloTabla.addRow(filas2);
                    frmversalidas.tblsalidas.setModel(frmversalidas.modeloTabla);
                }
                con.close();
                 cerrar();   
          ...
          void dobleclick() 
            {
                tblbuscasalidas.addMouseListener(new MouseAdapter() 
                {
                    ...
                    {  
                        ...
                        { 
                            frmversalidas modificar= new frmversalidas();
 ...
 TableRowSorter trs; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmbuscasalidasver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmbuscasalidasver().setVisible(true);
            }
        });
    }
