 ...
 */
public final class frmbuscaentradascancelar extends javax.swing.JFrame {
    ...
    private int fila;
    frmcancelarentradas modificar= new frmcancelarentradas();
    public frmbuscaentradascancelar() 
    {
        initComponents();
        configModelo();
        iniciotabla();
    ...
    void iniciotabla()
        ...
        {   
            ...
            {   
                ...
                while(rs.next())
                {
                   frmcancelarentradas.txtnoproveedor.setText(rs.getString(1));
                   frmcancelarentradas.txtproveedor.setText(rs.getString(2));
                   String tippago = rs.getString(3);
                if("1".equals(tippago))
                {    
                    frmcancelarentradas.txttipopago.setText("Contado");                    
                }
                else
                {    frmcancelarentradas.txttipopago.setText("Credito");                   
                } 
                    frmcancelarentradas.txtdiascredito.setText(rs.getString(4)); 
                    frmcancelarentradas.txttelefono.setText(rs.getString(5));
                }
                ...
                {    String fecha, fechapago,anio,aniopago,mes,mespago,dias,diaspago;   
                     ...
                     fecha=dias+"/"+mes+"/"+anio;
                     frmcancelarentradas.txtfecha.setText(fecha);
                     frmcancelarentradas.txtnoentrada.setText(rss.getString(1));  
                     ...
                     frmcancelarentradas.txtfechapago.setText(fechapago);
                     frmcancelarentradas.lbltotal.setText(rss.getString(5));
                     frmcancelarentradas.txttipoentrada.setText( rss.getString(9));
                ...
                {   
                    ...
                    frmcancelarentradas.modeloTabla.addRow(filas2);  
 ...
 TableRowSorter trs; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmbuscaentradascancelar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmbuscaentradascancelar().setVisible(true);
            }
        });
    }
