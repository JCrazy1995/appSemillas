 ...
 */
public final class frmbuscaentradasver extends javax.swing.JFrame {
    ...
    void iniciotabla()
        ...
        {   
            ...
            {   
                ...
                while(rs.next())
                {
                   frmverentradas.txtnoproveedor.setText(rs.getString(1));
                   frmverentradas.txtproveedor.setText(rs.getString(2));
                   String tippago = rs.getString(3);
                if("1".equals(tippago))
                {    
                    frmverentradas.txttipopago.setText("Contado");                    
                }
                else
                {    frmverentradas.txttipopago.setText("Credito");                   
                } 
                    frmverentradas.txtdiascredito.setText(rs.getString(4)); 
                    frmverentradas.txttelefono.setText(rs.getString(5));
                }
                ...
                {    String fecha, fechapago,anio,aniopago,mes,mespago,dias,diaspago;   
                     ...
                     fecha=dias+"/"+mes+"/"+anio;
                     frmverentradas.txtfecha.setText(fecha);
                     frmverentradas.txtnoentrada.setText(rss.getString(1));  
                     ...
                     frmverentradas.txtfechapago.setText(fechapago);
                     frmverentradas.lbltotal.setText(rss.getString(5));
                     frmverentradas.txttipoentrada.setText( rss.getString(9));
                ...
                {   
                    ...
                    frmverentradas.modeloTabla.addRow(filas2);  
 ...
 TableRowSorter trs; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmbuscaentradasver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmbuscaentradasver().setVisible(true);
            }
        });
    }
